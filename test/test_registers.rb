...
class TestRegisters < Test::Unit::TestCase
  ...
  def test_register_named_raises_error_with_bad_register_name
    assert_raise(HAIthermo::Thermostat::Registers::RegisterError) { @thermo.register_named(:bad_reg) }
    assert_raise(HAIthermo::Thermostat::Registers::RegisterError) { @thermo.register_named(:addresses) }
  end
  ...
  def test_register_number_raises_error_with_bad_register_number
    assert_raise(HAIthermo::Thermostat::Registers::RegisterError) { @thermo.register_number(-1) }
    assert_raise(HAIthermo::Thermostat::Registers::RegisterError) { @thermo.register_number(74) }
  end
  ...
  def test_setting_a_register_with_invalid_value
    assert_raise(HAIthermo::Thermostat::Register::RegisterError) { @thermo.address.value = 0 }
    assert_raise(HAIthermo::Thermostat::Register::RegisterError) { @thermo.address.value = 200 }
    assert_raise(HAIthermo::Thermostat::Register::RegisterError) { @thermo.communication_mode.value = 2 }
    assert_raise(HAIthermo::Thermostat::Register::RegisterError) { @thermo.communication_mode.value = 10 }
    assert_raise(HAIthermo::Thermostat::Register::RegisterError) { @thermo.communication_mode.value = 11 }
  end
