...
class TestRegisterBase < MiniTest::Test
  def setup
  ...
  def test_creating_new_register_outside_allowable_register_number_raises_error
    assert_raises(HAIthermo::Thermostat::Register::RegisterError) { HAIthermo::Thermostat::Register::Base.new(-1, "address", (0..127)) }
    assert_raises(HAIthermo::Thermostat::Register::RegisterError) { HAIthermo::Thermostat::Register::Base.new(74, "address", (0..127)) }
    assert_raises(HAIthermo::Thermostat::Register::RegisterError) { HAIthermo::Thermostat::Register::Base.new(555, "address", (0..127)) }
  end
  ...
  def test_setting_value_outside_limits_raises_error
    assert_raises(HAIthermo::Thermostat::Register::RegisterError) { @register.value = 128 }
    assert_raises(HAIthermo::Thermostat::Register::RegisterError) { @register.value = -1 }
    @register = HAIthermo::Thermostat::Register::Base.new(0, "address", [0, 3, 55])
    assert_raises(HAIthermo::Thermostat::Register::RegisterError) { @register.value = 1 }
    assert_raises(HAIthermo::Thermostat::Register::RegisterError) { @register.value = 12 }
    assert_raises(HAIthermo::Thermostat::Register::RegisterError) { @register.value = 56 }
  end
  ...
  def test_setting_register_value_set_updated_at
    ...
    refute_equal(test_time, @register.updated_at)
    @register.value = 8
