...
class TestMessageFactory < MiniTest::Test
  def setup
  ...
  def test_hex_string_to_string
    hex_string = "07 fc 61"
    assert_equal("\a\374a".force_encoding("ASCII-8BIT"), @mf.hex_string_to_string(hex_string))
    hex_string = "07 fc 45 31 00 ff"
    assert_equal("\a\374E1\000\377".force_encoding("ASCII-8BIT"), @mf.hex_string_to_string(hex_string))
  end
