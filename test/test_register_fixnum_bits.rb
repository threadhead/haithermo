...
class TestFixnumBits < MiniTest::Test
  ...
  def test_bits_within_bounds
    assert_raises(ArgumentError) { -1.bit_set(0) }
    assert_raises(ArgumentError) { 256.bit_set(0) }
    # assert_nothing_raised(ArgumentError) { 0.bit_set(0) }
    # assert_nothing_raised(ArgumentError) { 255.bit_set(0) }
    assert_raises(ArgumentError) { -1.bit_clear(0) }
    assert_raises(ArgumentError) { 256.bit_clear(0) }
    # assert_nothing_raised(ArgumentError) { 0.bit_clear(0) }
    # assert_nothing_raised(ArgumentError) { 255.bit_clear(0) }
    assert_raises(ArgumentError) { -1.bit_get(0) }
    assert_raises(ArgumentError) { 256.bit_get(0) }
